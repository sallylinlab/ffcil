...
def get_command_line_parser():
    ...
    parser.add_argument('-dataset', type=str, default='auo',
                        choices=['mini_imagenet', 'cub200', 'cifar100', 'auo', 'stanford_dogs'])
    ...
    parser.add_argument('-batch_size_new', type=int, default=128, help='set 0 will use all the availiable training image for new')
    ...
    parser.add_argument('-order', action='store_true', help='set orederNet')

    # for episode learning
    parser.add_argument('-train_episode', type=int, default=50)
    parser.add_argument('-epochs_res', type=int, default=0)
    parser.add_argument('-epochs_proj', type=int, default=0)
    ...
    parser.add_argument('-opt_dir', type=str, default=MODEL_DIR, help='loading optimizer parameter from a specific dir')
    parser.add_argument('-set_no_val', action='store_true', help='set validation using test set or no validation')

    parser.add_argument('-extra_class', action='store_true', help='set using extra set')
    parser.add_argument('-pseudo_mode', type=str, default='rotate',
                        choices=['rotate', 'color', 'rc'])
    # about training
