    ...
    def _pre_operate(self, root):
        ...
        if self.train:
            for k in train_idx:
                ...
                if int(id2class[k]) >=131 and int(id2class[k])<140:
                    label_ = int(id2class[k]) + 9
                elif int(id2class[k]) >=141 and int(id2class[k])<150:
                    label_ = int(id2class[k]) - 11
                else:
                    label_ = int(id2class[k]) - 1
                self.targets.append(label_)
                self.data2label[image_path] = (label_)
