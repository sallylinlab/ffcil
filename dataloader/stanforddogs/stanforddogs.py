...
class StanfordDogs(Dataset):
    ...
    def __init__(self, root='./data', train=True,
                 transform=None,
                 index_path=None, index=None, base_sess=None, valid=False):
        self.IMAGE_PATH = "/mnt/backups/sun/lechien/dataset/stanford_dogs" #"/home/lechien/dataset/stanford_dogs/"
        ...
        self.SPLIT_PATH = os.path.join(root, 'stanford_dogs')
...
if __name__ == '__main__':
    txt_path = "../../data/index_list/stanford_dogs/session_1.txt"
    # class_index = open(txt_path).read().splitlines()
    base_class = 100
    class_index = np.arange(base_class)
    dataroot = '~/data'
    batch_size_base = 400
    trainset = StanfordDogs(root=dataroot, train=True, transform=None, index_path=txt_path)
